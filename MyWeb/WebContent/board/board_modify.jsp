               ...
               <div class="panel">
                   ...
                   <div class="panel-body">
                       <form action="/MyWeb/update.board" method="post">
                             <input type="hidden" name="bId" value="${ModiBoard.boardId }">
                           <div class="form-group">
                               <label for="writer" hidden>작성자</label>
                               <input id="writer" name="bWriter" value="${ModiBoard.writer }" 
                               type="text" class="form-control" readonly>
                           </div>
   
                           <div class="form-group">
                               <label for="title" hidden>글제목</label>
                               <input id="title" name="bTitle" type="text" class="form-control" value="${ModiBoard.title }">
                           </div>
   
                           <div class="form-group">
                               <label for="content" hidden>글내용</label>
                               <textarea id="content" name="bContent" class="form-control" rows="5">
                               ${ModiBoard.content }
                               </textarea>
                           </div>
